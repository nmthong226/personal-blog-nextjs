    ...
    return (
        <div className='group grid grid-cols-12 gap-4 items-center text-dark dark:text-light'>
            ...
            <div className='col-span-12 lg:col-span-8 w-full'>
                <span className='w-full inline-block uppercase text-accent dark:text-accentDark font-semibold text-xs sm:text-sm'>{blog.tags[0]}</span>
                ...
                <span className='w-full inline-block capitalize text-dark/50 dark:text-light/50 font-semibold text-xs sm:text-base '>
