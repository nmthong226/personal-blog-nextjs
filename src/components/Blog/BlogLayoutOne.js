        ...
        <div className='group inline-block overflow-hidden rounded-xl'>
            ...
            <div className='absolute bottom-0 p-4 xs:p-6 sm:p-10 z-20'>
                ...
                <Link href={blog.url} className='mt-6'>
                    <h2 className='font-bold capitalize text-sm xs:text-base sm:text-xl md:text-2xl text-light mt-2 ms:mt-4'>
                        <span className='bg-gradient-to-r from-accent to-accent bg-[length:0px_6px] dark:from-accentDark/50 dark:to-accentDark/50
